...
nohup python main.py -m=NCF -d=multi -es=128 -lr=0.001 -do=0.2 >./log/NCF_lr001.log 2>&1 
echo "NCF lr1 end"
nohup python main.py -m=NCF -d=multi -es=128 -lr=0.0003 -do=0.2 >./log/NCF_lr0003.log 2>&1 
echo "NCF lr2 end"
nohup python main.py -m=NCF -d=multi -es=128 -lr=0.0001 -do=0.2 >./log/NCF_lr0001.log 2>&1 
echo "NCF lr3 end"
nohup python main.py -m=NCF -d=multi -es=128 -lr=0.00003 -do=0.2 >./log/NCF_lr00003.log 2>&1 
echo "NCF lr4 end"
nohup python main.py -m=NCF -d=multi -es=128 -lr=0.00001 -do=0.2 >./log/NCF_lr00001.log 2>&1 
echo "NCF lr5 end"
# 0.00001
