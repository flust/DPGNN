...
class LightGCN2(PJFModel):
    def __init__(self, config, pool):
        super(LightGCN2, self).__init__(config, pool)
...
#         edges_0 = torch.cat((self.pool.geek_ids, self.n_users + self.pool.job_ids), 0)
#         # edges_1: job_node -> geek_node
#         edges_1 = torch.cat((self.pool.n_userss + self.job_id, self.pool.geek_ids), 0)
