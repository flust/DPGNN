...
#     def forward(self, pos_score, neg_score_u, neg_score_i):
#         loss = -torch.log(self.gamma + torch.sigmoid(pos_score - neg_score_u - neg_score_i)).mean()
#         return loss
...
class MultiGCN(PJFModel):
    def __init__(self, config, pool):
        ...
        self.ADD_BLOSS = config['ADD_BLOSS']
        self.ADD_MLOSS = config['ADD_MLOSS']
    ...
    def calculate_loss(self, interaction):
        ...
        mf_loss_u = self.mf_loss(pos_scores, neg_scores_u)
        mf_loss_i = self.mf_loss(pos_scores, neg_scores_i)
